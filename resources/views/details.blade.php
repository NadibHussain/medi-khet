...
<br>
 ...
 <section class="portfolio" id="portfolio">
    ...
    <div class="media-left">
      <img src="{{asset('img/products/'.$product[0]->Image.'.jpg')}}" class="media-object img-thumbnail" style="width:300px;margin-right: 100px;height: 200px;">
    </div>
    <div class="jumbotron" style="padding: 0px; width:600px;">
    <div class="card-body">
      <h4 class="media-heading" style="color: #444">{{$product[0]->Name}}</h4>
      <br>
      
      <h6>Scientific Name: {{$product[0]->ScientificName}} </h6>
      <p>Price: {{$product[0]->Price}} BDT</p>
      <p>{{$product[0]->Description}}</p>
      <form action="{{url('cart/'.$product[0]->Name)}}" method="POST" style="width: 200px"  >
             {{ csrf_field() }}
