      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          ...
          <li class="nav-item mx-0 mx-lg-1">
            ...
            <li class="nav-item mx-0 mx-lg-1">
              <a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="<?php echo e(url('/')); ?>">Blogs</a>
            </li>
            <li class="nav-item mx-0 mx-lg-1">
...
<br>
 ...
 <a href="<?php echo e(url('detail/$product ->Name')); ?>">
  <img src="img/products/<?php echo e($product->Image); ?>.jpg" alt="John Doe" class="mr-3 mt-3 rounded" style="width:100px;"></a>
  <div class="media-body">
   <a href="<?php echo e(url('detail/'.$product ->Name)); ?>"> <h4> <?php echo e($product->Name); ?></h4></a>
