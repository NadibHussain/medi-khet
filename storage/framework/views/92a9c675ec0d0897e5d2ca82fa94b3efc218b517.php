...
<link href="<?php echo e(asset('vendor/bootstrap/css/bootstrap.min.css')); ?>" rel="stylesheet">
 ...
 <nav class="navbar navbar-expand-lg bg-secondary fixed-top text-uppercase " id="mainNav">
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          ...
          <li class="nav-item mx-0 mx-lg-1">
            ...
            <li class="nav-item mx-0 mx-lg-1">
              <a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="<?php echo e(url('/cart')); ?>">ChEck Out</a>
            </li>
            <li class="nav-item mx-0 mx-lg-1">
        ...
        <div class="row" >
         ...
         <div class=bordered-box>
          ...
          <div class="card" style="height: 400px;">
            ...
            <img class="prof" src="<?php echo e(asset('img/products/'.$products[0]->Image.'.jpg')); ?>" alt="John" style="width:50%" >
         ...
         <form action="<?php echo e(url('cart/'.$products[0]->Name)); ?>" method="POST" style="position: absolute; 
                bottom: 0; 
                width: 100%; ">
             <?php echo e(csrf_field()); ?>
         ...
         <div class=bordered-box >
          ...
          <a href="<?php echo e(url('detail/'.$products[1]->Name)); ?>" style="text-decoration: none;">         
            <img class="img-fluid" src="<?php echo e(asset('img/products/'.$products[1]->Image.'.jpg')); ?>" alt="John" style="width:50%" >
         <h3><?php echo e($products[1]->Name); ?></h3>
          ...
          <form action="<?php echo e(url('cart/'.$products[1]->Name)); ?>" method="POST"  style="position: absolute; 
                bottom: 0; 
                width: 100%; ">
             <?php echo e(csrf_field()); ?>
         ...
         <div class=bordered-box >
          ...
          <a href="<?php echo e(url('detail/'.$products[2]->Name)); ?>" style="text-decoration: none;">         
            <img class="img-fluid" src="<?php echo e(asset('img/products/'.$products[2]->Image.'.jpg')); ?>" alt="John" style="width:50%" >
         <h3><?php echo e($products[2]->Name); ?></h3>
          ...
          <form action="<?php echo e(url('cart/'.$products[2]->Name)); ?>" method="POST"  style="position: absolute; 
                bottom: 0; 
                width: 100%; ">
             <?php echo e(csrf_field()); ?>
         ...
         <div class=bordered-box >
          ...
          <a href="<?php echo e(url('detail/'.$products[3]->Name)); ?>" style="text-decoration: none;">         
            <img class="img-fluid" src="<?php echo e(asset('img/products/'.$products[3]->Image.'.jpg')); ?>" alt="John" style="width:50%" >
         <h3><?php echo e($products[3]->Name); ?></h3>
          ...
          <form action="<?php echo e(url('cart/'.$products[3]->Name)); ?>" method="POST"  style="position: absolute; 
                bottom: 0; 
                width: 100%; ">
             <?php echo e(csrf_field()); ?>
         ...
         <div class=bordered-box >
          ...
          <a href="<?php echo e(url('detail/'.$products[4]->Name)); ?>" style="text-decoration: none;">         
            <img class="img-fluid" src="<?php echo e(asset('img/products/'.$products[4]->Image.'.jpg')); ?>" alt="John" style="width:50%" >
         <h3><?php echo e($products[4]->Name); ?></h3>
          ...
          <form action="<?php echo e(url('cart/'.$products[4]->Name)); ?>" method="POST"  style="position: absolute; 
                bottom: 0; 
                width: 100%; ">
             <?php echo e(csrf_field()); ?>
        ...
        <div class="col-md-6 col-lg-4" >
         <div class=bordered-box >
          ...
          <a href="<?php echo e(url('detail/'.$products[5]->Name)); ?>" style="text-decoration: none;">         
            <img class="img-fluid" src="<?php echo e(asset('img/products/'.$products[5]->Image.'.jpg')); ?>" alt="John" style="width:50%" >
         <h3><?php echo e($products[5]->Name); ?></h3>
          ...
          <form action="<?php echo e(url('cart/'.$products[5]->Name)); ?>" method="POST"  style="position: absolute; 
                bottom: 0; 
                width: 100%; ">
             <?php echo e(csrf_field()); ?>
   ...
   <section class="bg-primary text-white mb-0" id="about">
    ...
    <img class="card-img-top" src="<?php echo e(asset('img/blogs/'.$blogs[0]->image.'.jpg')); ?>" alt="Card image" style="background-size: cover">
    <div class="card-body">
     ...
     <div class="card" style="width:300px;height: 470px;">
    <img class="card-img-top" src="<?php echo e(asset('img/blogs/'.$blogs[1]->image.'.jpg')); ?>" alt="Card image" style="background-size: cover">
    <div class="card-body">
     ...
     <div class="card" style="width:300px;height: 470px;">
    <img class="card-img-top" src="<?php echo e(asset('img/blogs/'.$blogs[2]->image.'.jpg')); ?>" alt="Card image" style="background-size: cover">
    <div class="card-body">
     ...
     <div class="card" style="width:300px;height: 470px;">
    <img class="card-img-top" src="<?php echo e(asset('img/blogs/'.$blogs[3]->image.'.jpg')); ?>" alt="Card image" style="background-size: cover">
    <div class="card-body">
      ...
      <div class="card" style="width:300px;height: 470px;">
    <img class="card-img-top" src="<?php echo e(asset('img/blogs/'.$blogs[4]->image.'.jpg')); ?>" alt="Card image" style="background-size: cover">
    <div class="card-body">
    ...
    <div ng-include="'<?php echo e(asset('includes/footer.html')); ?>'"></div>
